              ...
              <div>
                ...
                <div className="mt-12 grid gap-4 sm:grid-cols-2 xl:grid-cols-4">
                  {[
                    ...
                    <div key={stat.label} className="rounded-3xl border border-slate-200 bg-[#FCFCFC] p-5">
                      <p className="text-xs uppercase tracking-[0.3em] text-slate-500">{stat.label}</p>
                      <p className="mt-4 text-3xl font-semibold text-[#1A1A1A]">{stat.value}</p>
                    </div>
                  ))}
                </div>
              </div>
        ...
        <section id="how-it-works" className="mt-20">
          ...
          <div className="grid gap-4 overflow-x-auto pb-6 sm:grid-cols-3 lg:grid-cols-6">
            {[
              ...
              <div key={step} className="group relative rounded-[1.75rem] border border-slate-200 bg-white p-6 text-center shadow-sm">
